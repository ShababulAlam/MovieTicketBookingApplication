...
import movieticketmanagementsystemn.Shyamoli;

/**
 *
 * @author lenovo
 */
public class MovieInfoSH5 extends javax.swing.JFrame {
    ...
    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/movieinformations","root", "");
     System.out.println("conection done");
         ...
         while(rs.next()){
             ...
             jTextField2.setText(rs.getString("price3"));
             jTextField5.setText(rs.getString("price3"));
             jTextField8.setText(rs.getString("price3"));
             jTextField11.setText(rs.getString("price3"));
