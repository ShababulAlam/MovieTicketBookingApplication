 ...
 * @author lenovo
 */
public class MovieInfoBB5 extends javax.swing.JFrame {
...
{ 
    ...
    con = DriverManager.getConnection("jdbc:mysql://localhost:3306/movieinformations","root", "");
     System.out.println("conection done");
         ...
         while(rs.next()){
             //Times from Database
             jTextField1.setText(rs.getString("Time2"));
             jTextField4.setText(rs.getString("Time2"));
             jTextField7.setText(rs.getString("Time3"));
             jTextField10.setText(rs.getString("Time3"));
